      ...
      <CCard className="mt-4 shadow-sm">
        <CCardHeader className="d-flex justify-content-between align-items-center">
          ...
          {hasPermission && hasPermission('create_master') && (
            <CButton color="primary" className="float-end" onClick={() => { setForm({ name: '', status: 'active' }); setEditId(null); setModal(true); }}>Add Unit</CButton>
          )}
        </CCardHeader>
        <CCardBody>
        ...
        <CModal visible={modal} onClose={() => setModal(false)}>
          <CModalHeader onClose={() => setModal(false)}>{editId ? 'Edit' : 'Add'} Unit</CModalHeader>
