...
import {
  ...
  CForm, CFormInput, CFormSelect, CAlert, CSpinner, CTable, CTableHead, CTableRow, CTableHeaderCell, CTableBody, CTableDataCell, CPagination, CPaginationItem, CInputGroup, CInputGroupText, CRow, CCol
} from '@coreui/react';
      ...
      <CCard className="mt-4 shadow-sm">
        <CCardHeader className="d-flex justify-content-between align-items-center">
          ...
          {hasPermission && hasPermission('create_master') && (
            <CButton color="primary" className="float-end" onClick={() => { setForm({ name: '', status: 'active' }); setEditId(null); setModal(true); }}>Add Category</CButton>
          )}
        </CCardHeader>
        <CCardBody>
        ...
        <CModal visible={modal} onClose={() => setModal(false)}>
          <CModalHeader onClose={() => setModal(false)}>{editId ? 'Edit' : 'Add'} Category</CModalHeader>
