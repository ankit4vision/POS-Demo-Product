...
const API_URL = '/expense-categories';
      ...
      <CCard className="mt-4 shadow-sm">
        <CCardHeader className="d-flex justify-content-between align-items-center">
          ...
          {hasPermission && hasPermission('create_master') && (
            <CButton color="primary" className="float-end" onClick={() => { setForm({ name: '', status: 'active' }); setEditId(null); setModal(true); }}>Add Expense Category</CButton>
          )}
        </CCardHeader>
        <CCardBody>
        ...
        <CModal visible={modal} onClose={() => setModal(false)}>
          <CModalHeader onClose={() => setModal(false)}>{editId ? 'Edit' : 'Add'} Expense Category</CModalHeader>
